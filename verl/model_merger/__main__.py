...
python -m verl.model_merger merge \
    --backend fsdp \
    --local_dir /root/users/lzy/data2/lzy/checkpoints/verl_few_shot/Qwen2.5-Math-1.5B-Code-1shot/global_step_300/actor \
    --target_dir /root/users/lzy/data2/lzy/checkpoints/verl_few_shot/Qwen2.5-Math-1.5B-Code-1shot/global_step_300/actor
```
